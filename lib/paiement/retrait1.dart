...
class _Retrait1State extends State<Retrait1> {
  ...
  int currentPage = 0;
  int choice = 0;
  var _userTextController, flagUri;
            ...
            child: Form(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:MediaQuery.of(context).size.width>1000?240+add: 240, left: gauch, right: droit),
      ...
      child: Padding(
        ...
        child: GestureDetector(
          ...
          child: Column(
            children: <Widget>[
              Container(
                height:MediaQuery.of(context).size.width>1000?215: 85,
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.only(
                      topLeft: Radius.circular(10.0),
