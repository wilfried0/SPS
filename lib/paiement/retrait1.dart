...
class _Retrait1State extends State<Retrait1> {
  ...
  double aj,ajj,_taill,gauch, droit, hauteurcouverture, nomright, nomtop, right1, datetop, titretop, titreleft, amounttop, amountleft, amountright, topcolect, topphoto, bottomphoto, desctop, descbottom, bottomtext, toptext, left1, social, topo, div1, div2, margeleft, margeright;
  File _image;
  List data, list;
  Color color;
  // ignore: non_constant_identifier_names
            ...
            child: Form(
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child: Container(
                      decoration: new BoxDecoration(
                        borderRadius: new BorderRadius.only(
                          topLeft: Radius.circular(10.0),
                          topRight: Radius.circular(10.0),
                          bottomLeft: Radius.circular(indik==0?10.0:0),
                          bottomRight: Radius.circular(indik==0?10.0:0),
                        ),
                        color: Colors.transparent,
                        border: Border.all(
                            color: couleur_bordure,
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:340+aj+ajj,left: gauch, right: droit),
                    child: GestureDetector(
                      onTap: (){
                        this._save(montant);
                        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: Retrait2('$_code')));
