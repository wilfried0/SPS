...
class Confirme extends StatefulWidget {
  Confirme(this._code);
  String _code;

  @override
  _ConfirmeState createState() => new _ConfirmeState(_code);
}

class _ConfirmeState extends State<Confirme> {

  _ConfirmeState(this._code);
  String _code;
          ...
          leading: InkWell(
              onTap: (){
                setState(() {
                  ...
                  //Navigator.of(context).push(SlideLeftRoute(enterWidget: Cagnotte(_code), oldWidget: Confirme(_code)));
                });
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: new Text('Votre cagnotte a été offerte avec succès !',
                            style: TextStyle(
                                color: couleur_titre,
                    ...
                    Padding(
                      ...
                      child: new Text("Cliquez pour retourner à l'accueil Sprint Pay Community",
                        style: TextStyle(
