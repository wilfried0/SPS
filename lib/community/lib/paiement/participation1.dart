...
class Paiement1 extends StatefulWidget {
  Paiement1(_code);
 String _code;
  @override
  _Paiement1State createState() => _Paiement1State(_code);
}

class _Paiement1State extends State<Paiement1> {
  _Paiement1State(_code);
  String _code, kittyImage, kittyId,_sername, country, montant,_user_kitty, dial_code="+237", _token, _username, username, title, nom, email, description, mobileNumber, _url, currency, currencySymbol="CFA", _tel, flagUri="flags/cm.png";
  ...
  File _image;
  bool _value1 = false, _enable = true;
  ...
  lire() async {
    ...
    setState(() {
      ...
      dial_code = prefs.getString('dial');
      ...
      description = prefs.getString(MOTIF_PART);
      descriptionController.text = description;
      email = prefs.getString(EMAIL_PART);
      emailController.text = email;
      _value1 = prefs.getString(MASK_PART) == "true"?true:false;

      print("************************************** $flagUri, $dial_code");
    });
  }

  void getEnable(int indik){
    if(indik == 2){
      setState(() {
        phoneController.text = _sername;
        _enable = false;
      });
    }else{
      setState(() {
  ...
  void save() async {
    ...
    prefs.setString(ORIGIN, "participation1");
            ...
            child: Form(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Padding(
                      padding: EdgeInsets.only(top: 643, left: 20),
                      child: Container(
                        //color: Colors.white,
                        child: TextFormField(
                  ...
                  Padding(
                      padding: EdgeInsets.only(top: 688, left: 20),
                      child: Container(
                        //color: Colors.white,
                        child: TextFormField(
                  ...
                  Padding(
                      padding: EdgeInsets.only(top:indik == 2?736: 783, left: 20),
                      child: Container(
                        //color: Colors.white,
                        child: TextFormField(
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:indik == 2?773: 818),
                    child: Divider(
                      height: 5,
                      color: couleur_bordure,
                    ),
                  ...
                  Padding(
                      padding: EdgeInsets.only(top:indik == 2?785: 830, left: 20, right: 20),
                      child: Row(
                        children: <Widget>[
                          Expanded(
                            flex: 10,
                          ...
                          Expanded(
                              flex: 2,
                              child:currency==null?Container(): Text('$currency',
                                style: TextStyle(
                                    fontWeight: FontWeight.normal,
                                    color: couleur_libelle_champ,
                                    fontSize: taille_champ+3
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:indik==2?820: 865),
                    child: Divider(
                      height: 5,
                      color: couleur_bordure,
                    ),
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:indik==2?820: 865, left: 5),
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:indik==2?875: 920),
                    child: Container(
                      height: hauteur_champ,
                      width: MediaQuery.of(context).size.width,
                      color: couleur_champ,
                  ...
                  Padding(
                    padding: EdgeInsets.only(top:indik==2?920:960,bottom: 0),
                    child: InkWell(
                      onTap: (){
                        setState(() {
                          if(_formKey.currentState.validate()){
                            if(indik == 2 && _token == null){
                              ...
                              if(_tel == null && indik != 2){
                                ...
                                save();
                                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Paiement2(_code)));
                              }
                            }
                          }
                        });
  ...
  Widget getMoyen(int index){
    ...
    switch(index){
      ...
      break;
      case 3: text = "SPRINT-PAY WALLET";img = 'communityimages/sps.png';
      break;
      case 4: text = "CARTE PAYPAL";img = 'communityimages/carte.jpg';
      break;
    }
    return Container(
      width: MediaQuery.of(context).size.width,
