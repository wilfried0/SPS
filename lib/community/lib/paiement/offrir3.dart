...
class _Offrir3State extends State<Offrir3> {
  ...
  File _image;
  List data, list;
  String currency, flag, dialcode, kittyImage,_xaf="XAF", _iso,_myselection = "+237", phone, previsional_amount, amount_collected, kittyId, firstnameBenef,particip, endDate, startDate, title, suggested_amount, amount, description, number, nom="", tel="", email="", montant="", mot="";
                        ...
                        children: <Widget>[
                          Expanded(
                              ...
                              child: Padding(
                                ...
                                child:flag==null?Container(): new Image.asset('$flag'),
                              ),
                          ),
                          Expanded(
                            flex: 2,
                              child: dialcode == null?Container():Text(dialcode),
                          ),
                          new Expanded(
                            flex:10,
                            child: new TextFormField(
                              ...
                              validator: (String value){
                                if(value.isEmpty){
                                  ...
                                  number = dialcode.substring(1)+value;
                                  //_sername = value;
                                  return null;
                                }
                              },
