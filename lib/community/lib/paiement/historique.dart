...
class _HistoriqueState extends State<Historique> with SingleTickerProviderStateMixin {
  ...
  String _username,deviseLocale, _password, _token;
  DateTime date;
  bool isLoding = true;
  ...
  read() async {
    ...
    setState(() {
      ...
      _url = "$cagnotte_url/trans/allTrans/user";
      this.getHistorique();
    });
  }
  ...
  Future<void> getHistorique() async {
    ...
    if(response.statusCode == 200){
      ...
      showInSnackBar('Votre token a expiré. Veillez vous reconnecter');
    }
  }
    ...
    return new Scaffold(
          ...
          body:data == null?Center(child: CupertinoActivityIndicator(radius: 30,)):ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i){
               var _reference = data[i]['reference'];
               var _amount = data[i]['amount'];
               var _date = data[i]['dateTrans'];
               var timeTrans = data[i]['timeTrans'];
               var _status = data[i]['status'];
               var _nature = data[i]['type'];
               var _receiver = data[i]['receiver'];
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: <Widget>[
                                        Text(getNature(_nature), style: TextStyle(
                                            color: couleur_titre,
                                            fontWeight: FontWeight.bold,
                          ...
                          Expanded(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text("${getMillis(_amount.toString())} $currency", style: TextStyle(
                                        color:getStatus(_status)=="Approuvé"? Colors.green:Colors.red,
                                        fontWeight: FontWeight.bold,
                                        fontSize: taille_champ
                                    ),),
                                    ...
                                    Text(timeTrans, style: TextStyle(
                                        color: couleur_titre,
                                        fontSize: taille_champ-2
                                    ),),
                                  ],
  ...
  String getNature(String nature){
    String _nature = "";
    if(nature == "ENCASH"){
      _nature = "Encaissement \ncagnotte";
    }else if(nature == "CONTRIBUTE_BY_WALLET"){
      _nature = "Contribution \ncagnotte Wallet";
    }else if(nature == "CONTRIBUTE_BY_OM"){
      _nature = "Contribution \nOrange Money";
    }else if(nature == "CONTRIBUTE_BY_MOMO"){
      _nature = "Contribution \nMTN Mobile Money";
    }else if(nature == "CONTRIBUTE_BY_PAYPAL"){
      _nature = "Contribution \nPAYPAL";
    }else{
      _nature = "$nature";
    }
