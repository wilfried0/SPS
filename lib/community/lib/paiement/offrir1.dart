...
class Offrir1 extends StatefulWidget {
  Offrir1(this._code);
  String _code;
  @override
  _Offrir1State createState() => new _Offrir1State(_code);
}

class _Offrir1State extends State<Offrir1> {
  _Offrir1State(this._code);
  String _code;
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text('Quel montant souhaitez-vous offrir?',
                      style: TextStyle(
                          color: couleur_libelle_champ,
                          fontSize: taille_champ+3,
                          fontWeight: FontWeight.bold
                      ...
                      onTap: (){
                        ...
                        if(_formKey.currentState.validate()){
                          if((double.parse(montant.replaceAll(".", ""))+double.parse(montant.replaceAll(".", ""))*0.05)<=double.parse(remain)){
                            ...
                            this._ackAlert(context, "Le montant à offrir doit être inférieur à ${double.parse(remain)-double.parse(remain)*0.05}");
                          }
                        }
                      },
                      child: Container(
