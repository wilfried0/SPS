...
class DetailTransaction extends StatefulWidget {
  DetailTransaction(this._code);
  String _code;
  @override
  _DetailTransactionState createState() => new _DetailTransactionState(_code);
}

class _DetailTransactionState extends State<DetailTransaction> with SingleTickerProviderStateMixin {
  _DetailTransactionState(this._code);
  String _code;
  ...
  read() async {
    ...
    setState(() {
      ...
      _url = "$cagnotte_url/transaction/getTransactionById/$deviseLocale/$_transactionid";
    });
    //this.loadMap(0);
  }
