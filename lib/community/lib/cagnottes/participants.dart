...
class Participants extends StatefulWidget {
  Participants(this._code);
  String _code;

  @override
  _ParticipantsState createState() => new _ParticipantsState(_code);
}

class _ParticipantsState extends State<Participants> {

  _ParticipantsState(this._code);
  String _code, _token, _url, participant;
  bool isLoding = false;
  int choix, kittyId;
  List parts;
    ...
    return new Scaffold(
      ...
      Center(
        child: Padding(
          ...
          child: Text('Aucun participant enregistré à cette cagnotte', style: TextStyle(
              fontSize: taille_champ+3,
              color: couleur_libelle_champ
