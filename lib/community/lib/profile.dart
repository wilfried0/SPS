                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Align(
                        ...
                        child: loadImage == false?Text(_code.split('^')[0]!=null?'${_code.split('^')[0]}':'',//Nom du connecté
                          style: TextStyle(
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: loadImage == false?Text(_code.split('^').length>1?'${_code.split('^')[1]}':"",//Ville du connecté
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                        ...
                        onTap: (){
                          setState(() {
                            if(idUser == null || idUser == '-1'){
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Cagnotte('true')));
