...
class Kitty{
  ...
  final String previsional_amounttontine;
  ...
  Kitty({this.title, this.startDate, this.endDate, this.description, this.firstnameBenef, this.lastnameBenef, this.number, this.kittyImage, this.currency, this.previsional_amounttontine, this.visibility, this.status, this.suggested_amount, this.amount, this.suggest_amount_to_guest,
  ...
  Kitty.fromJson(Map<String, dynamic> json)
      : title = json['title'],
        ...
        previsional_amounttontine = json['previsional_amount'],
  ...
  Map<String, dynamic> toJson() =>
      {
        ...
        "currency": currency,
        "previsional_amount": previsional_amounttontine,
