...
class Kitty{
  ...
  Kitty({this.title, this.startDate, this.endDate, this.amount, this.description, this.firstnameBenef, this.lastnameBenef, this.number, this.phone, this.kittyImage, this.currency, this.previsional_amount, this.visibility, this.status, this.suggested_amount, this.suggest_amount_to_guest,
...
class TontineC{
  ...
  TontineC({this.amounttontine, this.avatar, this.delayTimes, this.description, this.invitations, this.name, this.paticipationDuration, this.startDate,});
  TontineC.fromJson(Map<String, dynamic> json)
      : amounttontine = json['amount'],
        avatar = json['avatar'],
