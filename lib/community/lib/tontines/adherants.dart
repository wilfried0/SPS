import 'package:services/community/lib/tontines/detailtontine.dart';
...
class _HommeState extends State<Adhesion> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      onWillPop: (){
        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => DetailTontine('')));
      },
      child: Scaffold(
        appBar: AppBar(
          title: new Text(
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: [
                  new Text('+'+itemName, style: TextStyle(fontSize: 16.0),),
                  Spacer(),
                  RaisedButton(
