...
import 'tontine1.dart';
import '../utils/components.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Paysctontine extends StatefulWidget {
  @override
  _PaysctontineState createState() => new _PaysctontineState();
}

class _PaysctontineState extends State<Paysctontine> {

  List data;
  List unfilterData;
  bool isLoading =false;
  String _urlt, iso3, flagUri, dial_code, currency, currencySymbol;
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();

  @override
  void initState(){
    this.loadMap();
    _urlt = "$cagnotte_url/user/currencyUser/";
    super.initState();
  }
  ...
  getCurrency(String code3) async {
    ...
    if(response.statusCode == 200){
      ...
      this._save();
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => Tontine1()));
    }else{
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        leading: InkWell(
            onTap: (){
              setState(() {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => Tontine('')));
              });
            },
        ...
        children: <Widget>[
          Padding(
            ...
            child: Align(
              ...
              child: new Text('Dans quel pays est destiné la tontine ?',
                  style: TextStyle(
                      color: couleur_titre,
