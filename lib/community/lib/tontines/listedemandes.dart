...
class Homme1 extends StatefulWidget {
  @override
  _Homme1State createState() => _Homme1State();
}

class _Homme1State extends State<Homme1> {

  final List<String>listof = ["mangue","banane","orange","tomate","citron"];
